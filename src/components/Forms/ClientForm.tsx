...
export const ContactForm = () => {
  ...
  return (
    <div className="bg-white dark:bg-dark-surface p-4 sm:p-6 rounded-lg shadow-lg border border-[#88D4E4] dark:border-dark-accent max-w-xl mx-auto w-full max-h-[85vh] flex flex-col">
      <h3 className="text-lg sm:text-xl font-bold text-[#171D4C] dark:text-dark-text mb-3 text-center">
        {t.title || 'Regístrate para Cotizar y Comprar'}
      </h3>
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto space-y-3 pr-2">
          {/* 1. País */}
          <div>
            <label htmlFor="pais" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-dark-accent rounded-md focus:outline-none focus:ring-2 focus:ring-[#139ED4] focus:border-[#139ED4] transition-colors bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text text-sm"
              required
            >
          ...
          {/* 2. Tipo de Cliente */}
          <div>
            <label className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
            ...
            <div className="flex gap-4">
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <span className="text-gray-700 dark:text-gray-300 text-sm">{t.persona || 'Persona Natural'}</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
                  ...
                  className="mr-2"
                />
                <span className="text-gray-700 dark:text-gray-300 text-sm">{t.empresa || 'Empresa'}</span>
              </label>
            </div>
          </div>

          {/* 3. Documento Personal (para personas) */}
          {clientType === 'PERSONA_NATURAL' && (
            <div>
              <label htmlFor="documentoPersonal" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 dark:border-dark-accent rounded-md focus:outline-none focus:ring-2 focus:ring-[#139ED4] focus:border-[#139ED4] transition-colors bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text text-sm"
                  required
                />
                {paisSeleccionado?.iso_code_2 === 'PE' && (
                  <button
                    ...
                    className="px-3 py-2 bg-[#139ED4] text-white rounded-md hover:bg-[#0D7BA7] disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-xs"
                  >
                    {t.consultar}
                  </button>
                )}
          ...
          {/* 4. Documento Empresa (para empresas) */}
          {clientType === 'EMPRESA' && (
            <div>
              <label htmlFor="documentoEmpresa" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
          ...
          {/* 5. Nombre */}
          <div>
            <label htmlFor="nombre" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border border-gray-300 dark:border-dark-accent rounded-md focus:outline-none focus:ring-2 focus:ring-[#139ED4] focus:border-[#139ED4] transition-colors bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text text-sm ${nombreBloqueado ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
          ...
          {/* 6. Apellidos */}
          <div>
            <label htmlFor="apellidos" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
      ...
      {/* 7. Razón Social (para empresas) */}
          {clientType === 'EMPRESA' && (
            <div>
              <label htmlFor="razonSocial" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
              ...
              <input
                ...
                className={`w-full px-3 py-2 border border-gray-300 dark:border-dark-accent rounded-md focus:outline-none focus:ring-2 focus:ring-[#139ED4] focus:border-[#139ED4] transition-colors bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text text-sm ${razonBloqueada ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
          ...
          {/* 8. Rubro */}
          <div>
            <label htmlFor="rubroEmpresa" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
          ...
          {/* 9. Teléfono */}
          <div>
            <label htmlFor="telefono" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
              {t.telefono || 'Teléfono'}
            </label>
            <div className="flex gap-2">
              {paisSeleccionado && (
                <span className="px-3 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-dark-accent rounded-md text-gray-700 dark:text-gray-300 text-sm">
          ...
          {/* 10. Correo */}
          <div>
            <label htmlFor="correo" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
          ...
          {/* 11. Contraseña */}
          <div>
            <label htmlFor="contrasena" className="block text-[#171D4C] dark:text-dark-text font-medium mb-1 text-sm">
          ...
          <div>
            ...
            <div 
              className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-3 text-center cursor-pointer hover:border-[#139ED4] transition-colors"
            ...
            >
              <div className="text-gray-500 dark:text-gray-400">
                ...
                <p className="text-xs">{t.elegirArchivos || 'Elegir archivos'}</p>
                <p className="text-xs text-gray-400 mt-1">{t.formatos || 'Excel, PDF, Word, imágenes'}</p>
              </div>
              <input
                ref={fileInputRef}
                type="file"
                ...
                {files.map((file, index) => (
                  <div key={index} className="flex items-center justify-between bg-gray-50 dark:bg-gray-700 p-2 rounded text-xs">
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      <svg className="h-3 w-3 text-gray-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M3 4a1 1 0 011-1h3a1 1 0 011 1v1h2V4a1 1 0 011-1h3a1 1 0 011 1v1h1a1 1 0 110 2h-1v9a2 2 0 01-2 2H6a2 2 0 01-2-2V7H3a1 1 0 110-2h1V4z" clipRule="evenodd" />
                      </svg>
          ...
          {apiFeedback && (
            <div className={`p-2 rounded-md text-xs ${
              ...
              apiFeedback.type === 'success' ? 'bg-green-50 text-green-700' :
              ...
              {apiFeedback.type !== 'loading' && apiFeedback.message}
            </div>
          )}
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#139ED4] hover:bg-[#0D7BA7] text-white font-medium py-2.5 px-4 rounded-md transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center text-sm"
          >
            {submitting ? (
              <>
